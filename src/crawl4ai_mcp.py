"""
Simplified RAG MCP Server with Crawl4AI.

This server provides essential web crawling and RAG capabilities for AI agents,
automatically detecting the appropriate crawl method based on URL type.
...
- Contextual Embeddings: Enriches chunks with context for better retrieval
- Hybrid Search: Combines vector and keyword search
- Agentic RAG: Specialized code example extraction and search
